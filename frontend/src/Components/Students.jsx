...
function Students() {
  return (
    // list all students and add option to add remove and update students
    <div className="manage-students">
      <div className="students-list">
        {studentsList.map((student) => (
          <div className="student-card">
            <div className="card-item id">ID: {student.id}</div>
            <div className="card-item name">Name: {student.name}</div>
            <div className="card-item batch">Batch: {student.batch}</div>
            {/* <div className="list-item bio">{student.bio}</div> */}
          </div>
        ))}
      </div>
    </div>
